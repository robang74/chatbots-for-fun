...
Well - *cannot be replaced* - in the sense of a spare part because mechanical changes to the case in order to fit a standard PSU supply as well as providing a cable for adapt the standard 20/24-pins ATX connector to the motherboard 16-pin one, is always possible.
