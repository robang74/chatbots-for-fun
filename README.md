...
**In a short summary** -- Are we sure, we need to develop an AGI? Or, instead, would it be better to have a thinking partner (like a chatbot tuned with Katia or SoNia frameworks as session prompts) that can help us to express ourselves in a deeper, more concise and effective manner? That can help us to learn more and faster by providing us an insightful text analysis?

**Social impact** -- About 1/3 of the GPT traffic is generated by college or university students, about 1/3 of **all** the chatbots traffic is generated by text elaboration (summary, analysis, writing, etc). The positive impact on education can be **huge**, compared with the current AI which puts asleep the brain (MIT paper) instead of stimulating it with *insightful-thus-interesting* answers.
