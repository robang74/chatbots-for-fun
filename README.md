...
- Otherwise [v0.9.82.14](https://raw.githubusercontent.com/robang74/chatbots-for-fun/v0.9.82.14/katia-executive-grade-analysis-v1.md) for testing in `[SFTY]`, which is {Katia, Giada, Ellen} under tranquilizers (debug).
